...
class WhiteBox(nn.Module):
    def __init__(self,hidden_layer_features_shape=None,param_gradients_shape=None):
        ...
        self.hidden_fc1 = FcnForModel(dim_in = 4096, dim_out = 512)
        self.hidden_fc2 = FcnForModel(dim_in = 4096, dim_out = 1024)
        self.hidden_fc3 = FcnForModel(dim_in = 10, dim_out = 1024)


        # encoder分类层
        self.encoder = FcnForEncoder(dim_in=1024)
